...
myst:
  html_meta:
    "description": "Multilingual configuration for lineage child sites"
    "property=og:description": "Multilingual configuration for lineage child sites"
    "property=og:title": "lineage.multilingual"
    "keywords": "lineage.multilingual, documentation, Multilingual configuration for lineage child sites"
---

# lineage.multilingual

Welcome to the documentation for lineage.multilingual!
